...
class Rag:
    ...
    def generate_subqueries(self, query):
        ...
        prompt = f"""
                     ...
                     # Пример
                     Заявката "България част ли е от шенгенското пространство и ако да, кога е станало това?" 
                     се превръща в следните подзаявки:
                     1. България част ли е от шенгенското пространство?
                     2. Ако България е член на шенгенското пространство, кога е станала България член на шенгенското 
                     пространство?          
                     За заявката от този пример НЕ трябва да се връща например подзаявка "Ако да, кога е станало това", 
                     защото тази заявка не съдържа никакъв контекст в себе си, трябва да се замени "Ако да" с 
                     "Ако България е член на шенгенското пространство", за да се разбере какво се има предвид,
                     докато "кога е станало това" не се разбира кое "това" се има предвид и трябва да се замени с 
                     "кога е станала България член на шенгенското пространство", така че втората ти подзаявка трябва да 
                     бъде "Ако България е член на шенгенското пространство, кога е станала България член на шенгенското 
                     пространство?". Трябва всички неясни части в подзаявката да бъдат заменени с това, което се има 
                     предвид, за да може всяка подзаявка да се използва за retrieval процеса в RAG система.
